...
const promotions = [
  { label: "EASYLIFE WELLNESS HUB", title: "Natural health for a vibrant life.", text: "Explore wellness products, education, and practical support.", image: "/wellness.jpeg", to: "/collection", destination: "easylifewellnesshub.com/collection", action: "Shop wellness products" },
  { label: "EARN WITH EASYLIFE", title: "Become an EASYLIFE Distributor", text: "Buy selected products at distributor prices, sell to your customers, and manage your stock from your own dashboard.", image: "/wellness.jpeg", to: "/dashboard?distributor=apply", destination: "Apply in your EASYLIFE account", action: "See distributor benefits" },
  { label: "EASYLIFE FAMILY", title: "Visit EASYLIFE Supermarket", text: "Shop everyday essentials for your home and family.", image: "/supermarket.jpeg", to: "https://supermarket.easylifewellnesshub.com", destination: "supermarket.easylifewellnesshub.com", action: "Visit supermarket" },
  { label: "EASYLIFE FAMILY", title: "Visit EASYLIFE Clinic", text: "Book eye-care appointments and get the support you need.", image: "/ceo.png", imageClass: "service-promo-image-ceo", to: "https://clinic.easylifewellnesshub.com", destination: "clinic.easylifewellnesshub.com", action: "Visit clinic" },
];
