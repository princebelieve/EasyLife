...
const customerSteps = [
  ...
  ["3", "Choose how to receive the order", "Choose EASYLIFE office pickup in Benin City to pay no shipping fee, or choose delivery to a transport company or park in your selected state. Delivery is for collection at the terminal, not doorstep delivery."],
  ...
  ["6", "Choose payment", "Pay online through Paystack, use direct EASYLIFE bank transfer when enabled, or choose the pay-on-delivery transfer instruction. The delivery agent confirms an official transfer before handover and does not collect cash."],
...
const adminTasks = [
  ...
  ["Payments", "Configure official EASYLIFE bank-transfer details and decide whether direct transfer is available alongside Paystack."],
  ...
  return (
    <>
      ...
      <main className="how-to-use-page">
        <section className="how-to-use-hero"><div className="container"><span className="eyebrow">EASYLIFE APP GUIDE</span><h1>How EASYLIFE works for every role.</h1><p>Use this guide to shop, receive an order, become a distributor, or manage the platform as an administrator or subadmin.</p><div className="easy-actions"><Link className="easy-btn easy-btn-primary" to="/collection">Start shopping</Link><Link className="easy-btn easy-btn-light" to="/dashboard">Open my dashboard</Link></div></div></section>
        ...
        <section className="how-to-use-help"><div className="container"><h2>Need help with an order or application?</h2><p>Use the support guide for answers, or contact EASYLIFE for help with products, transport collection, payment, distributor applications, or account access.</p><div className="easy-actions"><Link className="easy-btn easy-btn-primary" to="/support">Open support guide</Link><Link className="easy-btn easy-btn-light" to="/contact">Contact EASYLIFE</Link></div></div></section>
      </main>
      <Footer />
    </>
  );
