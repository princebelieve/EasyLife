...
export default function AdminTestimonials() {
  ...
  function edit(item) {
    setEditing(item._id);
    setMediaType(item.videoFile ? "video" : item.audioFile ? "audio" : "image");
    setForm({ ...blank, ...item });
  }
