  ...
  return (
    <>
      ...
      <main className="easy-life-home">
        ...
        <section className="director-home-feature"><div className="container director-home-feature-grid"><div className="director-home-portrait"><span>MEET OUR DIRECTOR</span><img src="/ceo.png" alt="Dr. Chinasa Nwaka, licensed optometrist and Director of Easy Life Wellness Hub" /></div><div className="director-home-copy"><p className="easy-eyebrow">LEADERSHIP WITH HEART</p><h2>Meet Dr. Chinasa Nwaka.</h2><p>Licensed optometrist Dr. Chinasa Nwaka leads Easy Life Wellness Hub, Easy Life Clinic, and Easy Life Supermarket. With her team, she brings wellness products, practical education, and community support together in one place.</p><Link to="/our-director" className="easy-btn easy-btn-primary">Meet our Director <ArrowRight size={18} /></Link></div></div></section>
