...
export default function PwaInstallInstructions() {
  return (
    <div className="container" style={{ padding: 28 }}>
      <h1>Install EASYLIFE App</h1>
      <p>
        On iOS (Safari), add EASYLIFE to your home screen to use it like an app.
      </p>
      ...
      <ol>
        ...
        <li>Confirm — the EASYLIFE icon will appear on your home screen.</li>
      </ol>
